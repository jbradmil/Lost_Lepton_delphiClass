...
void EffMaker::SlaveBegin(TTree * /*tree*/)
{
  ...
  // 2D
  MuIsoPTActivity_ = new TH2Eff("MuIsoPTActivity","MuIsoPTActivity",oneDActivity_-1,OneDActivity_,oneDPT_-1,OneDPT_);
  ElecIsoPTActivity_ = new TH2Eff("ElecIsoPTActivity","ElecIsoPTActivity",oneDActivity_-1,OneDActivity_,oneDPT_-1,OneDPT_);
  MuRecoPTActivity_ = new TH2Eff("MuRecoPTActivity","MuRecoPTActivity",oneDActivity_-1,OneDActivity_,oneDPT_-1,OneDPT_);
  ElecRecoPTActivity_ = new TH2Eff("ElecRecoPTActivity","ElecRecoPTActivity",oneDActivity_-1,OneDActivity_,oneDPT_-1,OneDPT_);
  ...
  if(muReco==2)
    {
      ...
      //2D
      MuRecoPTActivity_->Fill(GenMu_MT2Activity->at(0),GenMus->at(0).Pt(),Weight,true);
  ...
  if(muReco==0)
    {
      ...
      //2D
      MuRecoPTActivity_->Fill(GenMu_MT2Activity->at(0),GenMus->at(0).Pt(),Weight,false);
  ...
  if(elecReco==2)
    {
      ...
      //2D
      ElecRecoPTActivity_->Fill(GenElec_MT2Activity->at(0),GenEls->at(0).Pt(),Weight,true);
  ...
  if(elecReco==0)
    {
      ...
      //2D
      ElecRecoPTActivity_->Fill(GenElec_MT2Activity->at(0),GenEls->at(0).Pt(),Weight,false);
  ...
  if(muIso==2)
    {
      ...
      //2D
      MuIsoPTActivity_->Fill(GenMu_MT2Activity->at(0),GenMus->at(0).Pt(),Weight,true);
  ...
  if(muIso==0)
    {
      ...
      //2D
      MuIsoPTActivity_->Fill(GenMu_MT2Activity->at(0),GenMus->at(0).Pt(),Weight,false);
  ...
  if(elecIso==2)
    {
      ...
      //2D
      ElecIsoPTActivity_->Fill(GenElec_MT2Activity->at(0),GenEls->at(0).Pt(),Weight,true);
  ...
  if(elecIso==0)
    {
      ...
      //2D
      ElecIsoPTActivity_->Fill(GenElec_MT2Activity->at(0),GenEls->at(0).Pt(),Weight,false);
...
void EffMaker::Terminate()
{
  ...
  MuRecoPTActivity_->SaveEff("#mu reco; Activity;p_{T}(#mu) [GeV]", dEfficiencies, true);   
  ...
  MuIsoPTActivity_->SaveEff("#mu Iso; Activity; p_{T}(#mu) [GeV]", dEfficiencies, true);   
  ...
  ElecRecoPTActivity_->SaveEff("e reco; Activity;p_{T}(e) [GeV]", dEfficiencies, true);   
  ...
  ElecIsoPTActivity_->SaveEff("e Iso; Activity; p_{T}(e) [GeV]", dEfficiencies, true);   
